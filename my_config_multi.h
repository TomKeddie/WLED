...
#undef MAX_LEDS
#define MAX_LEDS 36       //Maximum total LEDs. More than 1500 might create a low memory situation on ESP8266

#undef WLED_AP_SSID
#undef WLED_AP_PASS
#undef DEFAULT_AP_SSID
#undef DEFAULT_AP_PASS

#define WLED_AP_SSID "WLED_AP_NN"
#define WLED_AP_PASS WLED_AP_SSID
#define DEFAULT_AP_SSID WLED_AP_SSID
#define DEFAULT_AP_PASS WLED_AP_SSID
